...
Color raytracer::raytracers::_private_::RayTracerv1::determine_color(const Scene& scene, const MaterialProperties& properties, const Hit& hit, const math::Ray& ray) const
{
    Color ambient = compute_ambient(properties);
    return ambient;
}

Color raytracer::raytracers::_private_::RayTracerv1::compute_ambient(const MaterialProperties& matprop) const
{
    return matprop.ambient;
}
