...
#       undef BIND
	...
	struct EasingLibrary
	{
        ...
        EasingFunction elastic(int x, int y) const
        {
            return math::functions::easing::elastic(x, y);
        }

        EasingFunction bounce(int x, int y) const
        {
            return math::functions::easing::bounce(x, y);
        }
